...
if __name__ =="__main__":
    ...
    #this function calculates the confusion matrix statistics to work out sensitivity and Specificity
        ...
        print("Sensitivity = %0.3g  " %sensitivity)
        print("Specificity = %0.3g  " %specificity)
    ...
    print("Test Error Rate = %0.3g " % (1.0 - accuracy)) # error rate is 100% - the accuracy of the classifier
    ...
    print("Test Error Rate = %0.3g " % (1.0 - accuracy2))
    ...
    print("Test Error Rate =  %0.3g " % (1.0 - accuracy3))
